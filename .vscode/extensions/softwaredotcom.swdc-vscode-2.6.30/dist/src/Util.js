...
exports.isPrimaryWindow = exports.getImage = exports.checkRegistrationForReport = exports.noSpacesProjectDir = exports.showWarningMessage = exports.showInformationMessage = exports.humanizeMinutes = exports.launchWebUrl = exports.launchWebDashboard = exports.coalesceNumber = exports.getOffsetSeconds = exports.showOfflinePrompt = exports.logIt = exports.getLogId = exports.getExtensionName = exports.openFileInEditor = exports.displayReadme = exports.getLocalREADMEFile = exports.getSoftwareDir = exports.getFlowChangeFile = exports.getSessionSummaryFile = exports.getGitEventFile = exports.getSoftwareSessionFile = exports.getDeviceFile = exports.getOsUsername = exports.getOs = exports.getHostname = exports.isMac = exports.isWindows = exports.isLinux = exports.setAuthCallbackState = exports.getAuthCallbackState = exports.getPluginUuid = exports.isActiveIntegration = exports.getItem = exports.setItem = exports.isFlowModeEnabled = exports.updateFlowChange = exports.getNumberOfTextDocumentsOpen = exports.getFirstWorkspaceFolder = exports.getWorkspaceFolders = exports.isGitProject = exports.getEditorName = exports.getVersion = exports.getPluginType = exports.getPluginName = exports.getPluginId = exports.getWorkspaceName = exports.getRandomNumberWithinRange = exports.alpha = void 0;
...
function isFlowModeEnabled() {
    ...
    return (_a = (0, FileManager_1.getJsonItem)(getFlowChangeFile(), "in_flow")) !== null && _a !== void 0 ? _a : false;
}
...
function getAuthCallbackState(autoCreate = true) {
    let auth_callback_state = (0, FileManager_1.getJsonItem)(getDeviceFile(), 'auth_callback_state');
...
function getSoftwareDir() {
    ...
    const softwareDataDir = isWindows() ? `${homedir}\\${Constants_1.SOFTWARE_DIRECTORY}` : `${homedir}/${Constants_1.SOFTWARE_DIRECTORY}`;
