...
let timer = undefined;
const setEndOfDayNotification = (user) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    if (((_a = preferences.notifications) === null || _a === void 0 ? void 0 : _a.endOfDayNotification) !== false) {
        ...
        const response = yield (0, HttpClient_1.softwareGet)('/users/profile');
        if ((0, HttpClient_1.isResponseOk)(response)) {
