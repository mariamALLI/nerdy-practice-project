...
function updateStatusBarWithSummaryData() {
    let sessionSummary = (0, FileManager_1.getFileDataAsJson)((0, Util_1.getSessionSummaryFile)());
    if (!sessionSummary) {
    ...
    const minutesStr = (0, Util_1.humanizeMinutes)(sessionSummary.currentDayMinutes);
